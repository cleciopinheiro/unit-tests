...
const returnObject = createMenu(object);
...
describe('10 - Implemente a função `createMenu`, bem como seus casos de teste', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    expect(object).toEqual(createMenu(object).fetchMenu());
    ...
    expect(returnObject.order('coxinha')).toEqual(returnObject.consumption['coxinha']);
    expect(returnObject.order('carne')).toEqual('Item indisponível');
    ...
    expect(returnObject.order('agua')).toEqual(returnObject.consumption['coxinha', 'sanduiche', 'agua']);
